...
void imprime(char,char*,int,int*,float,float*);
int main(){
    char n1;
    char *n1p;
    int n2;
...
void imprime(char n1,char *n1p,int n2,int *n2p,float n3,float *n3p){
    printf("\nConteudo do apontado: %c\n",*n1p);
